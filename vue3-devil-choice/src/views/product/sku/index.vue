    ...
    <el-table border style="margin: 10px 0px" :data="skuArr">
      ...
      <el-table-column label="操作" width="250px" fixed="right">
        <template #="{row,$index}">
          ...
          <el-popconfirm :title="`你确定要删除${row.skuName}嘛~~~`" width="200px" @confirm="removeSku(row.id)">
            <template #reference>
...
//引入请求
import {reqSkuList,reqSaleSku,reqCancelSku,reqSkuInfo,reqRemoveSku} from '@/api/product/sku'
//引入类型
...
//编辑SKU
const updateSku = () => {
  ElMessage({type:'success',message:'客官不急，楚河正在努力更新~~~'})
}
//查看商品详情
