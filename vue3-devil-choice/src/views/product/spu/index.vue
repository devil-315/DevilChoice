<template>
  <div>
    ...
    <el-card style="margin:10px 0px">
      <div v-show="scene == 0">
        <el-button @click="addSpu" type="primary" size="default" icon="Plus" :disabled="categoryStore.c3Id ? false:false">添加SPU</el-button>
        <!-- 展示已有的SPU数据 -->
...
//场景数据
let scene = ref<number>(0) //0显示已有的SPU  1：添加或修改已有SPU 2：添加或修改已有SKU
//分页器默认的页码
...
//子组件SpuForm绑定自定义事件：让子组件通知父组件切换场景为 0
