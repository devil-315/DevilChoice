  ...
  <div>
    <el-form label-width="">
      ...
      <el-form-item label="SPU品牌">
        <el-select style="width: 150px" v-model="SpuParams.tmId">
          <el-option
      ...
      <el-form-item label="SPU销售属性">
        ...
        >
        <!-- table展示销售属性与属性值的地方 -->
        <el-table border style="margin-left: 10px" :data="saleAttr">
          <el-table-column
            label="序号"
            type="index"
            align="center"
...
let unSelectSaleAttr = computed(() => {
  ...
  let unSelectArr = allSaleAttr.value.filter((item) => {
    return saleAttr.value.every((j) => {
      return item.name != j.saleAttrName;
    });
  });
  return unSelectArr;
});
